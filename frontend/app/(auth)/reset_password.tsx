                ...
                <ScrollView contentContainerStyle={{ flexGrow: 1, padding: 24, paddingBottom: 40 }}>
                    ...
                    <View className="items-center justify-center mb-10 mt-6 relative">
                        ...
                        <View className="w-24 h-24 rounded-full bg-surface-dark items-center justify-center shadow-lg mb-6 border border-surface-highlight">
                            <MaterialIcons name="lock-open" size={48} color="#6366f1" />
                        </View>
                    ...
                    <View className="w-full gap-6 mb-8">
                        <View className="gap-2">
                            <Text className="text-sm font-medium text-text-secondary ml-1">University Email</Text>
                            <View className="relative justify-center">
                                <View className="absolute left-3 z-10">
                                    <MaterialIcons name="school" size={20} color="#94a3b8" />
                                </View>
                                <TextInput
                                    className="w-full bg-surface-dark border border-surface-highlight rounded-3xl py-3.5 pl-10 pr-12 text-white"
                        ...
                        <TouchableOpacity className="w-full rounded-3xl bg-primary py-3.5 items-center shadow-lg shadow-primary/25">
