        ...
        <SafeAreaView style={{ flex: 1, backgroundColor: colors.background, paddingTop: Platform.OS === 'android' ? StatusBar.currentHeight : 0 }}>
            ...
            <ScrollView style={{ flex: 1 }} contentContainerStyle={{ paddingBottom: 60 }} keyboardShouldPersistTaps="handled">
                ...
                <View style={{ paddingHorizontal: 20 }}>
                    ...
                    <LabeledInput label="Username" field="username" placeholder="" colors={colors} form={form} update={update} />
                    <LabeledInput label="Email" field="email" placeholder="" keyboardType="email-address" editable={false} colors={colors} form={form} update={update} />
                    <LabeledInput label="Phone" field="phone" placeholder="03123456789" keyboardType="phone-pad" colors={colors} form={form} update={update} />
                    ...
                    <LabeledInput label="Roll Number" field="rollNumber" placeholder="" colors={colors} form={form} update={update} />
                    <LabeledInput label="Major / Program" field="major" placeholder="e.g. Computer Science" colors={colors} form={form} update={update} />
                    <LabeledInput label="Department" field="department" placeholder="e.g. Computer Science Dept" colors={colors} form={form} update={update} />
                    <LabeledInput label="Start Year" field="startYear" placeholder="e.g. 2022" keyboardType="numeric" colors={colors} form={form} update={update} />
                </View>
            </ScrollView>
        </SafeAreaView>
    );
