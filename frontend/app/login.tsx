...
export default function LoginScreen() {
    ...
    const handleLogin = async () => {
        ...
        if (result.success) {
            ...
            Alert.alert('Email Not Verified', result.error || 'Please verify your email first. Check your inbox for the verification link.');
            setShowResend(true);
        } else {
                        ...
                        {showResend && (
                            ...
                            >
                                {resendLoading
                                    ...
                                    : <Text style={{ color: colors.primary, fontSize: 14, fontWeight: '600' }}>Did not receive verification email? Resend</Text>
                                }
                            </TouchableOpacity>
                        )}
                    </View>
